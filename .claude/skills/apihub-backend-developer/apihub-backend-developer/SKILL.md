...
11. **Related repos** — if the change touches deploy config, env vars, or REST contracts, remind the developer about Helm charts and/or Postman E2E repos per [docs/agent/related-repositories.md](../../../docs/agent/related-repositories.md) (no clone required).
