...
type PublishedRepository interface {
	...
	GetVersionsWithErroredReferences(ctx context.Context, packageId string) (map[entity.PublishedVersionKeyEntity]struct{}, error)
	GetVersionErrorSummary(ctx context.Context, packageId string, version string, revision int) (*entity.VersionErrorSummaryEntity, error)
	VersionHasErroredReferences(ctx context.Context, packageId string, version string, revision int) (bool, error)
