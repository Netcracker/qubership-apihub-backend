...
type PublishedRepository interface {
	...
	GetReadonlyVersionIncludingDeleted(packageId string, versionName string) (*entity.PackageVersionRevisionEntity, error)
	GetVersionByRevision(packageId string, versionName string, revision int) (*entity.PublishedVersionEntity, error)
	GetVersionByRevisionIncludingDeleted(packageId string, versionName string, revision int) (*entity.PublishedVersionEntity, error)
	...
	GetPackageVersionsListIncludingDeleted(searchQuery entity.PublishedVersionSearchQueryEntity) ([]entity.PackageVersionRevisionEntity, error)
	...
	GetParentsForPackageIncludingDeleted(id string) ([]entity.PackageEntity, error)
	...
	GetFilteredPackagesIncludingDeleted(searchReq view.PackageListReq, userId string) ([]entity.PackageEntity, error)
