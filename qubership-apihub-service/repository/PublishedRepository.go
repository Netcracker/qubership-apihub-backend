...
type PublishedRepository interface {
	...
	GetVersionInternalDocumentData(ctx context.Context, hash string) (*entity.EnrichedVersionInternalDocumentDataEntity, error)
	...
	GetComparisonInternalDocumentData(ctx context.Context, hash string) (*entity.EnrichedComparisonInternalDocumentDataEntity, error)
